...
@Component
public class LoadBalancedOrientDbFactory implements OrientDbFactory {
    public static final String ORIENTDB_NAME = "orientdb-data";
    private static final Logger LOGGER = LoggerFactory.getLogger(LoadBalancedOrientDbFactory.class);
    ...
    @Autowired
    public LoadBalancedOrientDbFactory(
